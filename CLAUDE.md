...
⚠️ `AUTH_SECRET` и пароль администратора были пересозданы на этапе 6 (2026-07-09) — новый `AUTH_SECRET` нужно продублировать в Vercel (текущее значение из Vercel устарело и приведёт к разлогину на проде, пока не обновлено).
